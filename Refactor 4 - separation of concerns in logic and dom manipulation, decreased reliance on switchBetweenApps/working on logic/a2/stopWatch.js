class StopWatch extends Time {
    ...
    runTimeData2 = {
        ...
        limits: [60, 60, 100],
        defaultTime: 0,
        callback: () => { this.stop(); this.reset(1, 0, 0); this.hours = true; this.start(); }
    }

    laps = [];

    //additional functions to run when app is reset
    runOnReset = [this.removeLaps, () => this.hours = false];

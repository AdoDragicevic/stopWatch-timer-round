...
class Time {
    ...
    constructor(disabledInputs = false, time = inputs, btns = buttons, customStyles = style) {
        ...
        this.style = customStyles[this.name.toLowerCase()];
    ...
    start() {
        ...
        if(this.style.runOnStart) for(let func of this.style.runOnStop) func.call(this);
        this.updateBtnTxt();
        this.disableInputs();
    ...
    updateDisplay() {
        ...
        this.disableInputs();
        this.updateBtnTxt();
        if(this.style.runOnUpdateDisplay) for(let func of this.style.runOnUpdateDisplay) func.call(this);
    }

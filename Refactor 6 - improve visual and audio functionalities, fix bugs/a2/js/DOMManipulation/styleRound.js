...
class StyleRound extends Style {
    ...
    updateCircleData = (runTimeData) => {
        if(!this.circleData) this.generateCircleData(runTimeData);
    ...
    generateCircleData = (runTimeData) => {
        this.circleData = {};
    ...
    runCircle = (runTimeData) => {
        let offsetPerInterval = this.circleData.perimeter / this.getDuration(runTimeData);

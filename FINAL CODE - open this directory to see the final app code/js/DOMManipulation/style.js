...
class Style {
    ...
    toggleSoundIcon(onIcon, offIcon, isSoundOn) {
        onIcon.style.display = isSoundOn ? "" : "none";
        offIcon.style.display = isSoundOn ? "none" : "";
    }
    ...
    setMainBtnColor() {
        ...
        btn.style.backgroundColor = this.isRunning ? "#A30000" : "#018301";
    }

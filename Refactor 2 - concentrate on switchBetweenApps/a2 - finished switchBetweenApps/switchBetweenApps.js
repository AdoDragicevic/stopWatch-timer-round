//Functionalities: change title, switch between apps, redirect btn event listeners, update data on screen for current app
class SwitchBetweenApps {
    ...
    constructor(h1, timeInputs, appsArr, switchBtn, lelftBtn, rightBtn){
        ...
        this.inputs.forEach((input, i) => this["d" + (i+1)] = input);
